...
#         return JsonResponse({'success': False, 'message': 'Product is already in your cart.'})

#     # Assuming the product has a default variant
#     product_variant = product.variants.first()
#     if not product_variant:
#         return JsonResponse({'success': False, 'message': 'No valid variant found for this product.'})
